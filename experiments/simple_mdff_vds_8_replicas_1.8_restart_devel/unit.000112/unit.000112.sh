...
export RP_UNIT_ID="unit.000112"
export RP_UNIT_NAME="task.0134,task7,stage.0134,Calculating the cross-correlation coefficient of full trajectory,pipeline.0005,simple-mdff-replica-5"
...
export RP_PROF="/gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000112//unit.000112.prof"
...
cd /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000112/
...
# The command to run
prof cu_exec_start
/opt/ibm/spectrum_mpi/jsm_pmix/bin/jsrun --erf_input /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000112//unit.000112.rs   /gpfs/alpine/world-shared/bip115/VMD_binaries/VMD-1.9.3-xlc-build-2019-Dec-12/bin/vmd -dispdev text -e seventh_stage.tcl
RETVAL=$?
prof cu_exec_stop
