...
export RP_UNIT_ID="unit.000075"
export RP_UNIT_NAME="task.0081,generate griddx file,stage.0081,Converting the density map to an MDFF potential,pipeline.0003,simple-mdff-replica-3"
...
export RP_PROF="/gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000075//unit.000075.prof"
...
cd /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000075/
...
# The command to run
prof cu_exec_start
/opt/ibm/spectrum_mpi/jsm_pmix/bin/jsrun --erf_input /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000075//unit.000075.rs   /gpfs/alpine/world-shared/bip115/VMD_binaries/VMD-1.9.3-xlc-build-2019-Dec-12/bin/vmd -dispdev text -e second_stage.tcl
RETVAL=$?
prof cu_exec_stop
