...
export RP_UNIT_ID="unit.000170"
export RP_UNIT_NAME="task.0045,task6,stage.0045,NAMD simulation,pipeline.0001,simple-mdff-replica-1"
...
export RP_PROF="/gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000170//unit.000170.prof"
...
cd /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000170/
...
# The command to run
prof cu_exec_start
/opt/ibm/spectrum_mpi/jsm_pmix/bin/jsrun --erf_input /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000170//unit.000170.rs   /gpfs/alpine/world-shared/bip115/NAMD_binaries/summit/NAMD_build.latest/Linux-POWER-MPI-smp-Summit/namd2 "+ppn" "4" "adk-step1.namd" 
RETVAL=$?
prof cu_exec_stop
