...
export RP_UNIT_NAME="task.0009,None,stage.0009,Calculating the root mean square deviation for backbone atoms,pipeline.0000,simple-mdff"
...
export RP_PROF="/pylon5/mc3bggp/hrlee/radical.pilot.sandbox/re.session.two.hrlee.018334.0000/pilot.0000/unit.000009//unit.000009.prof"
...
cd /pylon5/mc3bggp/hrlee/radical.pilot.sandbox/re.session.two.hrlee.018334.0000/pilot.0000/unit.000009/
prof cu_cd_done
...
# The command to run
prof cu_exec_start
vmd -dispdev text -e ninth_stage.tcl
RETVAL=$?
prof cu_exec_stop
