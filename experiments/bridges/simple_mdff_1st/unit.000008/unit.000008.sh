...
export RP_UNIT_NAME="task.0008,None,stage.0008,Calculating the root mean square deviation,pipeline.0000,simple-mdff"
...
export RP_PROF="/pylon5/mc3bggp/hrlee/radical.pilot.sandbox/re.session.two.hrlee.018334.0000/pilot.0000/unit.000008//unit.000008.prof"
...
cd /pylon5/mc3bggp/hrlee/radical.pilot.sandbox/re.session.two.hrlee.018334.0000/pilot.0000/unit.000008/
prof cu_cd_done
