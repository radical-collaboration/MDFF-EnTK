...
export RP_UNIT_ID="unit.000175"
export RP_UNIT_NAME="task.0189,task6,stage.0189,NAMD simulation,pipeline.0007,simple-mdff-replica-7"
...
export RP_PROF="/gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000175//unit.000175.prof"
...
cd /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000175/
...
export fpath=`grep -v "a" $RP_PILOT_STAGING/*_1_cc.dat|sort -k2 -n -r|head -n1|cut -d":" -f1` ||  (echo "pre_exec failed"; false) || exit
...
# The command to run
prof cu_exec_start
/opt/ibm/spectrum_mpi/jsm_pmix/bin/jsrun --erf_input /gpfs/alpine/scratch/hrlee/bip115/radical.pilot.sandbox/re.session.login5.hrlee.018617.0020/pilot.0000/unit.000175//unit.000175.rs   /gpfs/alpine/world-shared/bip115/NAMD_binaries/summit/NAMD_build.latest/Linux-POWER-MPI-smp-Summit/namd2 "+ppn" "4" "adk-step1.namd" 
RETVAL=$?
prof cu_exec_stop
